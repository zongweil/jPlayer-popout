		...
		shuffle: function(shuffled, playNow) {
			...
			if(shuffled || shuffled !== this.shuffled) {
				...
				$(this.cssSelector.playlist + " ul").slideUp(this.options.playlistOptions.shuffleTime, function() {
					...
					// New song roots function
					var url = window.location.pathname;
					var location;
					if(url == 'test1.php')
						location = 'test1';
					else if(url == 'test2.php')
						location = 'test2';
						
					var object_id = $('body').data('object_id');
					$.ajax({
						type: "POST",
						url: '../../jPlayer/like/load_like_roots.php',
						data: {location: location, object_id: object_id },
